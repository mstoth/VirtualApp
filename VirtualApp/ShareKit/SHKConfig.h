...
#define SHKDeliciousConsumerKey		@"dj0yJmk9VVJ2d3U1SnBsM2hsJmQ9WVdrOWRWVnVUVUZ2TldjbWNHbzlPRGN6TXpFNE5qWXkmcz1jb25zdW1lcnNlY3JldCZ4PWUy"
#define SHKDeliciousSecretKey		@"df9b82288afd30478677a16089caab43415861be"
...
#define SHKFacebookKey				@"143085459093289"
#define SHKFacebookSecret			@"c352c8cf082b9e1406943f4528dcd7fc"
#define SHKFacebookSessionProxyURL  @""

// Read It Later - http://readitlaterlist.com/api/?shk
#define SHKReadItLaterKey			@"62egfwe0p0gR1n0Zm8Tib44T6fArl1b3"
 ...
 */
#define SHKTwitterConsumerKey		@"EhiusUmdFnl3oDJvSfKHw"
#define SHKTwitterSecret			@"gWL739onyOtNwI58l8BxmYrbknV8ZEUxzpLsa4YbFw"
#define SHKTwitterCallbackUrl		@"my-iphone-app.com" // You need to set this if using OAuth, see note above (xAuth users can skip it)
